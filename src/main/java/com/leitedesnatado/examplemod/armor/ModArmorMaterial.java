package com.leitedesnatado.examplemod.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RUBY(ExampleMod.MOD_ID + ":ruby", 25, new int[] { 7, 9, 11, 7 }, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0, () -> { return Ingredient.fromItems(ModItems.RUBY.get());});
	;
